...
你有没有好奇过——那些在朋友圈刷屏的人格测试，到底是怎么做出来的？

从星座到塔罗，从 MBTI 到 SBTI，从大五人格到九型人格……每隔一段时间就有一个新的人格测试刷爆全网。你做完了，截图了，转发了——但你有没有想过：**这些测试背后的技术实现，其实都是同一套模式？**

本仓库不提供任何特定测试的完整题库或美术资产。

本仓库做的事情是：**拆解趣味人格测试的通用实现机制，提供一个可复用的引擎框架，并横向对比 12 种主流人格/命运测试的原理与科学边界。**
...
**变的是标签的形式，不变的是我们想要被理解、被归类、被允许表达真实自己的渴望。**
