...
const dimensionMeta = {
  ...
  "LOVE-R": {
    ...
    "cn": "多情者",
    "intro": "爱意太满，现实显得有点贫瘠。",
    "desc": "LOVE-R人格像远古神话时代幸存至今的珍稀物种，其存在概率比随手一捞就捞到珍稀物种还低。您简直是这个钢铁森林时代最后的、也是最不合时宜的吟游诗人。因为您的情感处理器不是二进制的，而是彩虹制的。一片落叶，在常人眼里只是“秋天来了”，在LOVE-R眼中，则是一场关于轮回、牺牲与无言之爱的十三幕悲喜剧。您内心世界像一座永不关门的主题公园，一生都在寻找那个能看懂园区地图、并愿意陪你坐旋转木马直到宇宙尽头的灵魂伴侣。"
  },
  "MUM": {
    "code": "MUM",
    "cn": "妈妈",
  ...
  "THIN-K": {
    ...
    "cn": "思考者",
    "intro": "已深度思考100s。",
    "desc": "经研究发现，THIN-K人格的大脑构造与常人有根本性不同。正如名称所示，您的大脑长时间处于思考状态。您十分会审判信息，注重论点、论据、逻辑推理、潜在偏见，乃至“论述者三代以内思想背景调查报告”的全套材料。在这个信息爆炸的时代，您绝不会轻易盲从，会在关系中衡量利弊，也十分捍卫自己的自我空间。当别人看到您独处时在发呆？愚蠢，那不是发呆，那是您的大脑正在对今天接收到的所有信息进行分类、归档和销毁。"
  },
  "SHIT": {
    "code": "SHIT",
    "cn": "愤世者",
  ...
  "HHHH": {
    ...
    "cn": "傻乐者",
    "intro": "哈哈哈哈哈哈。",
    "desc": "恭喜您！由于您的思维回路过于清奇，标准人格库已全面崩溃。第一人格匹配率只有60％以下时，系统才会为您强制匹配这个人格——【HHHH - 傻乐者】。这个人格有什么特质？哈哈哈哈哈哈哈哈哈哈哈哈！对不起，这就是全部的特质了。您可以查看十五维度进行不专业的评估，实在是抱歉！人格类型库尚未覆盖所有脑回路，因此才会出现这样的状况。哈哈哈哈哈哈……笑着笑着，我便哭了出来。怎么会有人的脑回路这么新奇。"
  },
  "DRUNK": {
    "code": "DRUNK",
    "cn": "酒鬼",
    ...
    const TYPE_IMAGES = {
  "IMSB": "/packageImages/images/IMSB.png",
  "BOSS": "/packageImages/images/BOSS.png",
  "MUM": "/packageImages/images/MUM.png",
  "FAKE": "/packageImages/images/FAKE.png",
  "Dior-s": "/packageImages/images/Dior-s.jpg",
  "DEAD": "/packageImages/images/DEAD.png",
  "ZZZZ": "/packageImages/images/ZZZZ.png",
  "GOGO": "/packageImages/images/GOGO.png",
  "FUCK": "/packageImages/images/FUCK.png",
  "CTRL": "/packageImages/images/CTRL.png",
  "HHHH": "/packageImages/images/HHHH.png",
  "SEXY": "/packageImages/images/SEXY.png",
  "OJBK": "/packageImages/images/OJBK.png",
  "JOKE-R": "/packageImages/images/JOKE-R.jpg",
  "POOR": "/packageImages/images/POOR.png",
  "OH-NO": "/packageImages/images/OH-NO.png",
  "MONK": "/packageImages/images/MONK.png",
  "SHIT": "/packageImages/images/SHIT.png",
  "THAN-K": "/packageImages/images/THAN-K.png",
  "MALO": "/packageImages/images/MALO.png",
  "ATM-er": "/packageImages/images/ATM-er.png",
  "THIN-K": "/packageImages/images/THIN-K.png",
  "SOLO": "/packageImages/images/SOLO.png",
  "LOVE-R": "/packageImages/images/LOVE-R.png",
  "WOC!": "/packageImages/images/WOC.png",
  "DRUNK": "/packageImages/images/DRUNK.png",
  "IMFW": "/packageImages/images/IMFW.png"
};
